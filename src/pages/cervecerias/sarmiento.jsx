    ...
    const fetchData = async () => {
      try {
        const [cervezasResponse, bebidasResponse] = await Promise.all([
          fetch("http://localhost:3000/cervezas/2"), // Aquí se utiliza el ID correspondiente para Sarmiento
          fetch("http://localhost:3000/bebidas/2"), // Aquí también, el ID debe coincidir con la ubicación
        ]);
    ...
    <div className="relative min-h-screen w-screen bg-zinc-900 bg-cover bg-center text-white font-sans overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="relative h-[300px] w-full">
          <img
            src="/images/Sarmientowall.png" // Aquí se debe colocar la imagen correcta de la cervecería
            alt="Sarmiento Cervecería"
